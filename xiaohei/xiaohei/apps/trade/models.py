...
class OrderInfo(models.Model):
    ...
    user = models.ForeignKey(User, null = True,verbose_name='用户', help_text='用户', on_delete=models.CASCADE, related_name='order_infos')
    ...
    signer_mobile = models.CharField(max_length=11, default='',verbose_name='联系电话', help_text='联系电话')
