...
class GoodsCategory(models.Model):
    ...
    image = models.ImageField(upload_to='goods/images/', blank=True,null=True,verbose_name='封面图片', help_text='封面图片')
    class Meta:
...
class Banner(models.Model):
    ...
    goods = models.ForeignKey(Goods, related_name='banners',verbose_name='商品', help_text='商品', on_delete=models.CASCADE)
